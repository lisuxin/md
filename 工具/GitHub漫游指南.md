...
毕业后一个月收到PACKT出版社的邮件(ps: 他们是在github上找到我的)，内容是关于Review一本[物联网](http://github.phodal.com/iot)书籍，即在《[从Review到翻译IT书籍](http://www.phodal.com/blog/review-it-books-with-translate-book/)》中提到的《Learning Internet of Things》。作为一个四级没过的“物联网专家”，去审阅一本英文的物联网书籍。。。

当然，后来是审阅完了，书上有我的英文简介。

![Phodal Huang Introduction](http://github.phodal.com/img/phodal-intro.jpg)Phodal Huang Introduction

一个月前，收到MANNING出版社的邮件(ps: 也是在github上)，关于Review一本[物联网](http://github.phodal.com/iot)书籍的目录，并提出建议。
...
![Before add](http://github.phodal.com/img/before-add.png)Before add

下面是添加之后 的

![After add](http://github.phodal.com/img/after-add.png)After add
...
![GitHub Roam](http://github.phodal.com/img/github-roam-create.jpg)GitHub Roam

就会有下面的提醒:

![GitHub Roam](http://github.phodal.com/img/project-init.jpg)GitHub Roam
...
![Google CLA](http://github.phodal.com/img/google-cla.png)Google CLA

以及Eclipse的一个PR

![Eclipse CLA](http://github.phodal.com/img/eclipse-cla.png)Eclipse CLA
...
![GitHub Project Introduction](http://github.phodal.com/img/github-intro.png)GitHub Project Introduction

## README

README通常会显示在GitHub项目的下面，如下图所示：

![GitHub README](http://github.phodal.com/img/readme-example.png)GitHub README

通常一个好的README会让你立马对项目产生兴趣。

如下面的内容是React项目的简介：

![React README](http://github.phodal.com/img/react-intro.png)React README
...
![Replace Temp With Query](http://github.phodal.com/img/replace.jpg)Replace Temp With Query
...
![2014 01 01](http://github.phodal.com/img/2014-01-01.png)2014 01 01
...
![Phodal Huang’s Report](http://github.phodal.com/img/phodal-results.png)Phodal Huang’s Report
...
![Feb Results](http://github.phodal.com/img/feb-results.png)Feb Results
...
![SMTWTFS](http://github.phodal.com/img/smtwtfs.png)SMTWTFS
...
![Main Event](http://github.phodal.com/img/main-events.png)Main Event
...
![Longest Streak](http://github.phodal.com/img/longest-streak.png)Longest Streak
...
![365 Streak](http://github.phodal.com/img/365-streak.jpg)365 Streak
...
![Repo Status](http://github.phodal.com/img/repo-status.png)Repo Status
...
![Problem](http://github.phodal.com/img/problem.jpg)Problem
...
![GitHub 200 days](http://github.phodal.com/img/github-200-days.png)GitHub 200 days
...
![google map solr](http://github.phodal.com/img/solr.png)google map solr
...
![Skill Tree](http://github.phodal.com/img/skilltree.jpg)Skill Tree
...
![Sherlock skill tree](http://github.phodal.com/img/sherlock.png)Sherlock skill tree

代码: https://github.com/phodal/sherlock

#### Django Ionic ElasticSearch 地图搜索

![Django Elastic Search](http://github.phodal.com/img/elasticsearch_ionit_map.jpg)Django Elastic Search
...
![Resume](http://github.phodal.com/img/resume.png)Resume
...
![Nginx Pig](http://github.phodal.com/img/nginx_pig.jpg)Nginx Pig
...
![GitHub 365](http://github.phodal.com/img/github-365.jpg)GitHub 365
...
![lan](http://github.phodal.com/img/lan.png)lan![EchoesWorks](http://github.phodal.com/img/echoesworks.png)EchoesWorks
...
如果我们只是单纯地把我们的关注点仅仅放置于技术上，那么我们就不具有任何的优势。而依赖于我们的编程经验，我们可以在特定的时候创造一些框架。而架构的设计本身就是一件有意思的事，大抵是因为程序员都喜欢创造。(ps:之前曾经写过这样一篇文章，《[对不起，我并不热爱编程，我只喜欢创造](https://www.phodal.com/blog/sorry-i-don' rel=)》)
...
![Lan IoT](http://github.phodal.com/img/lan-iot.jpg)Lan IoT
...
![Gtihub 500](http://github.phodal.com/img/github-500.jpg)Gtihub 500
...
![情绪周期](http://github.phodal.com/img/qingxu.jpg)情绪周期
...
![打字练习](http://github.phodal.com/img/huovd.png)打字练习
...
2. `GitHub`主要操作一：创建一个仓库。写过代码的朋友可以理解为一个项目，一个模块，一个主题。创建仓库需要指定用户，仓库名，保密性，开源协议。 
3. `Github`主要操作二：上传文件或者文件夹。点击`addfile`添加空文件或者上传若干文件，/表示文件夹，文件夹不可为空。 
4. `Github`主要操作三：贡献操作之提交疑问或者描述和总结（Issues）。基于查看过代码仓库的前提提交问题和提交说明，仓库创建者有权利关闭问题并和网友评论问题以及添加标签。 
5. `Github`主要操作四：贡献操作之提交更改（Pull Requests）。你看了人家仓库的东西觉得有地方需要改进，那就别只会比比，把东西改了给人加到仓库里合并，顺便添加描述。 
6. `Github`主要操作五：白嫖（clone）！！！仓库可以公开可以私有，只要是遵循开源协议的公开仓库代码你都可以拿去用，但是不同的开源协议要求不同，所以自己再怎么学习也无所谓，但是你拿去商用那就小心点吧。 
7. `Github`主要操作六：版本管理功能。写一堆拉基代码没法用想回退版本，就是干这个的，给你后悔的机会。 
8. `Github`主要操作七：学会搜索资源。什么入门的，中文的，最牛逼的，最火的，跟学会百度一个道理。



在仓库名字的后面加[.git]；github搜索的方式来寻找新的仓库，

根据习惯生成仓库列表会用到github Explore会根据浏览习惯创建一个仓库列表每天刷新

####仓库管理：

创建一个仓库，往仓库里面添加文件；怎么提交一个Issue以及怎么提交及接受一个PULL request(拉取请求)《提交/接受PR》

创建仓库：点击加号下方的New repository然后选择仓库的主人，也就是他的所有者（Owner）;

然后是仓库的名称（Repository name）;《仓库的名称只能包含英文字母、横杠、下划线、和英文的句号；其他字符都会被Github转义为横杠》
